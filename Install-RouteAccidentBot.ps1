...
Write-Host "    .\Start-RouteAccidentBot.ps1      (consola)" -ForegroundColor Yellow
Write-Host "    .\Uninstall-RouteAccidentBot.ps1  (eliminar todo)`n" -ForegroundColor DarkGray
